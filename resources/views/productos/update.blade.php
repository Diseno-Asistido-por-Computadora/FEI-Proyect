        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col col-lg-8">
                    ...
                    <input type="number" class="form-control" name="preciodeventa" value="{{$Productos->preciodeventa}}">
                </div>
                <div class="col col-lg-2">
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col col-lg-8">
                    ...
                    <input type="number" class="form-control" name="preciodecosto" value="{{$Productos->Preciodecosto}}" >
                </div>
                <div class="col col-lg-2">
                </div>
            </div>
