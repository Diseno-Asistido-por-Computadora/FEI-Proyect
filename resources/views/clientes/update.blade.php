        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col col-lg-8">
                    ...
                    <textarea type="text" class="form-control" rows="3" name="direccion">{{$clientes->direccion}}</textarea>
                </div>
                <div class="col col-lg-2">
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col col-lg-8">
                    ...
                    <input type="number" class="form-control" name="telefono" value="{{$clientes->telefono}}">
                </div>
                <div class="col col-lg-2">
                </div>
            </div>
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col col-lg-8">
                    ...
                    <input type="email" class="form-control" name="Correo"  value="{{$clientes->Correo}}" >
                </div>
                <div class="col col-lg-2">
                </div>
            </div>
